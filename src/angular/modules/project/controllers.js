...
// 首页模块
  function indexPageController($scope, modal, alertWarn, requestData, alertOk, alertError) {
    ...
    // 全选与全不选
    // $scope.isChoiseAll1 = function (choiseStatus) {
    //
    //   if (choiseStatus) {
    //     angular.forEach($scope.orderMedicalNos, function (item, index) {
    //       if (!item.handleFlag) {
    ...
    // $scope.handleChoiseAllEvent1 = function () {
    //
    //   var _dataSource = $scope.formData.orderMedicalNos;
    //
    //   if (!$scope.choisedMedicalList) {
  ...
  .controller('indexPageController', ['$scope', 'modal', 'alertWarn', 'requestData', 'alertOk', 'alertError', indexPageController])
