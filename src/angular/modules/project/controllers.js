...
define('project/controllers', ['project/init'], function() {
     ...
     *编辑订单
     */
    function confirmOrderEditCtrl($scope, modal,alertWarn, watchFormChange,requestData,alertOk,alertError) {
      /**
      *保存
...
function SalesOrderDetailsController ($scope, $timeout, alertOk, alertError, requestData) {
  ...
  $scope.getCurrentProductionDate = function (relMedicalStockId,p_and_s) {
    ...
    .controller('confirmOrderEditCtrl', ['$scope', 'modal', 'alertWarn',' watchFormChange','requestData', 'alertOk', 'alertError', confirmOrderEditCtrl])
