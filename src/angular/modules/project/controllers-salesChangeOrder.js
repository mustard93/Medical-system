define('project/controllers-salesChangeOrder', ['project/init'], function() {
   ...
   */
  function  salesChangeOrderCtrl($scope, modal, watchFormChange, requestData, utils, alertError, alertWarn) {
  ...
  .controller('salesChangeOrderCtrl', ['$scope',"modal",'watchFormChange',"requestData", "utils", "alertError", "alertWarn", salesChangeOrderCtrl]);
});
