define('project/controllers-lossOverOrder', ['project/init'], function() {
  /**
  ...
  .controller('lossOverOrderEditCtrl', ['$scope',"modal",'alertWarn',"watchFormChange","requestData", lossOverOrderEditCtrl]);
});
