 ...
 * 项目业务类自定义指令
 */
define('project-dt/directives', ['project-dt/init'], function () {
  ...
  /**
   * [htmlEdit html-edit编辑器  <html-edit ng-model="htmlString"  div-id="divId"></html-edit>]
   * @method htmlEdit
   * @return {[type]} [description]
   */
  function htmlEdit() {
...
function angucompleteMedicalStockBatch($parse, requestData, $sce, $timeout) {
    return {
        ...
        link: function($scope, elem, attrs, ngModel) {
            ...
            require(['project-dt/angucomplete'], function(angucomplete) {
