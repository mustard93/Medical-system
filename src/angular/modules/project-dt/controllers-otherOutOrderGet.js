define('project-dt/controllers-otherOutOrderGet', ['project-dt/init'], function() {
  /**
   * [otherOutOrderGet 销售单控制器2]
   * @method otherOutOrderGet
   ...
   */
  function otherOutOrderGet($scope, modal, alertWarn, requestData, alertOk, alertError, utils, dialogConfirm) {
  ...
  .controller('otherOutOrderGet', ['$scope',"modal",'alertWarn',"requestData", "alertOk", "alertError", "utils", "dialogConfirm", otherOutOrderGet]);
});
