define('project-dt/controllers-entryExitTypeSetting', ['project-dt/init'], function() {
  /**
   ...
   */
  function entryExitTypeSettingController ($scope, modal, alertWarn, alertError, requestData, utils) {
  ...
  .controller('entryExitTypeSettingController', ['$scope',"modal",'alertWarn',"alertError", "requestData", "utils", entryExitTypeSettingController]);
});
