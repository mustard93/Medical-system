define('project-dt/controllers-otherInOrderGet', ['project-dt/init'], function() {
  /**
   * [otherInOrderGet 销售单控制器2]
   * @method otherInOrderGet
   ...
   */
  function otherInOrderGet($scope, modal, alertWarn, requestData, alertOk, alertError, utils, dialogConfirm) {
    ...
    $scope.submitFormAfter = function() {
      if ($scope.submitForm_type == 'exit') {
        $scope.goTo({tabHref:'#/invoicesOrder/query.html',tabName:'发货单'});
       return;
      ...
      if ($scope.submitForm_type == 'submit') {
        var _url='rest/authen/otherInOrder/startProcessInstance';
  ...
  .controller('otherInOrderGet', ['$scope',"modal",'alertWarn',"requestData", "alertOk", "alertError", "utils", "dialogConfirm", otherInOrderGet]);
});
