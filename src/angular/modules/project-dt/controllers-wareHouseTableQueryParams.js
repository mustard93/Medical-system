define('project-dt/controllers-wareHouseTableQueryParams', ['project-dt/init'], function() {
  /**
  ...
  */
  function paramsCtrl($scope, modal, alertWarn, alertError, requestData, watchFormChange, dialogAlert) {

      $scope.queryParamsConf= queryParams;

      console.log("$scope.queryParamsConf",$scope.queryParamsConf);
  ...
  .controller('paramsCtrl', ['$scope',"modal",'alertWarn',"watchFormChange", "requestData", "utils","dialogConfirm", paramsCtrl])
