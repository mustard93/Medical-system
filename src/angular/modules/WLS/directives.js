...
/**
  ...
  /**
   *  @Description: 排序过滤组件
   *  @模板： tpl/project/wlsSortCriteria.html
   *  @html定义样例：
   *    <create-sort-criteria list-params="listParams"
                         sort-list='[
                                     ...
                                     {"sortName":"创建时间","multipleRules":true,"rulesList":["由近到远","由远到近"]},
                                     {"sortName":"计划到货时间","multipleRules":true,"rulesList":["由近到远","由远到近"]}
                                    ]'>
        </create-sort-criteria>
      @attr： list-params
      @attr:  sort-list  排序组件必须属性，JSON字符串，定义需要排序的属性列表
      @author Liuzhen
      @date 2017/06/23
   */
