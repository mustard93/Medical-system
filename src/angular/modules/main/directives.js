...
define('main/directives', ['main/init'], function () {
   ...
   * 筛选
   */
  .directive('filterConditions', ['requestData', function (requestData) {
    'use strict';
    return {
        restrict: 'AE',
        scope: {},
   ...
   *  树状列表
   */
  .directive('treeList', ['requestData', '$timeout', function (requestData, $timeout) {
    'use strict';
    return {
        restrict: 'AE',
        scope: {},
   ...
   *  树状列表2
   */
  .directive('treeList2', ['requestData', 'modal', '$timeout', 'dialogConfirm', function (requestData, modal, $timeout, dialogConfirm) {
    'use strict';
    return {
        restrict: 'AE',
        require: "?^ngModel",
   ...
   *  导航列表
   */
  .directive('navList', ['requestData', function (requestData) {
    'use strict';
    return {
        restrict: 'AE',
        scope: true,
   ...
   *  异步下拉
   */
  .directive('selectAsync', ['requestData', function (requestData) {
    'use strict';
    return {
        restrict: 'A',
        scope: {},
   ...
   *  图表
   */
  .directive('eChart', ['requestData', 'dialogChart', function (requestData, dialogChart) {
    'use strict';
    return {
        restrict: 'A',
        scope: {
   ...
   *  自动补全
   */
  .directive('angucomplete', ['$parse', 'requestData', '$sce', '$timeout', function ($parse, requestData, $sce, $timeout) {
    'use strict';
    return {
        restrict: 'EA',
        scope: {
   ...
   *  下拉
   */
  .directive('chosen', ['requestData', '$timeout', function (requestData, $timeout) {
    'use strict';
    return {
        restrict: 'A',
        scope: {
   ...
   *  自定义配置 (资源相关)
   */
  .directive('customConfig', ['$timeout', function ($timeout) {
    'use strict';
    return {
        restrict: 'AE',
        scope: true,
