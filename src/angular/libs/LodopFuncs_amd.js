define('LodopFuncs',function(){
  ...
  function getLodop(oOBJECT,oEMBED){
    ...
    var strCLodopInstall="<br><font color='#FF00FF'>CLodop云打印服务(localhost本地)未安装启动!点击这里<a href='http://113.10.155.131/CLodopPrint_Setup_for_Win32NT.zip' target='_self'>执行安装</a>,安装后请刷新页面。</font>";
    var strCLodopUpdate="<br><font color='#FF00FF'>CLodop云打印服务需升级!点击这里<a href='http://113.10.155.131/CLodopPrint_Setup_for_Win64NT.zip' target='_self'>执行升级</a>,升级后请刷新页面。</font>";
    var LODOP;
    try {
      ...
      if (needCLodop()) {
        ...
        if (!LODOP) {
            ...
            document.documentElement.innerHTML=strCLodopInstall+document.documentElement.innerHTML; return;
          }
        } else {
  ...
  return {
    ...
    getLodop:getLodop,
    chkSystemPlugin: chkSystemPlugin
  };
});//define
